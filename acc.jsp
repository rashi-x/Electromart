       ...
       <div class="container d-flex justify-content-center mt-50 mb-50">
        ...
        <div class="row">
             <%
                ...
                ResultSet rs = stmt.executeQuery("SELECT id,description, image , price, emi FROM products WHERE category = 'other'");
                ...
                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <div class="mb-2">
                                            ...
                                            <a href="#" class="text-muted" data-abc="true">Accessories</a>
                                        </div>
